...
ActiveRecord::Schema.define(version: 20150910182546) do
  ...
  create_table "slocations", force: :cascade do |t|
    t.string   "code"
    t.string   "name"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "stories", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "mediacorp_id"
    t.string   "original_published_date"
  end
  ...
  create_table "story_slocation_joins", force: :cascade do |t|
    t.integer  "story_id"
    t.integer  "slocation_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "story_splace_joins", force: :cascade do |t|
    t.integer  "story_id"
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.integer  "role"
    t.string   "zip_preference"
  end

  add_index "users", ["email"], name: "index_users_on_email", unique: true, using: :btree
  add_index "users", ["reset_password_token"], name: "index_users_on_reset_password_token", unique: true, using: :btree

  create_table "usersavedplaces", force: :cascade do |t|
    t.integer  "user_id"
  ...
  add_index "usersavedplaces", ["user_id", "usersavedstory_id"], name: "index_usersavedplaces_on_user_id_and_usersavedstory_id", using: :btree
